...
<head>
    ...
    <title>Registro - GavaStore</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Regístrate en GavaStore</h2>
            ...
            <form method="POST" class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="direccion_envio" class="w-full p-2 border rounded"></textarea>
                </div>
                <button type="submit" name="register" class="w-full bg-gray-800 text-white p-2 rounded hover:bg-gray-900 transition">
                    Registrarse
                </button>
            </form>

            <p class="text-center mb-4 text-gray-600">¿Ya tienes cuenta? <a href="login.php" class="text-gray-800 font-semibold hover:underline">Inicia sesión aquí</a></p>
        </div>
    </div>
</body>
</html>